...
then
    test_unit twitter 4 sssp sssp 4 
...
# #     --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
   test_unit Slashdot0902 16 sssp sssp 64
# #    "--assemble=false \
# #     --serialization=true \
# #     --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
...
then
  ...
  # "--serialization=true \
  #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
  test_unit Slashdot0902 16 sim sim 64
  # "--assemble=false \
  #  --serialization=true \
  #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
fi
...
#   test_unit Epinions1 4 bfs bfs 16
#   # "--assemble=false"
#   test_unit Slashdot0811 8 bfs bfs 32
#   # "--serialization=true \
#   #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
#   test_unit Slashdot0902 16 bfs bfs 64
#   # "--assemble=false \
#   #  --serialization=true \
#   #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
# fi
...
then
  ...
  test_unit Epinions1 4 vf2 vf2 16
  # "--assemble=false"
  test_unit Slashdot0811 8 vf2 vf2 32
  # "--serialization=true \
  #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
  test_unit Slashdot0902 16 vf2 vf2 64
  # "--assemble=false \
  #  --serialization=true \
  #  --serialization_dir $GRAPE_HOME/build/grape-data/serialization"
fi
